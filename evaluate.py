...
def main():
    ...
    model = build_resnet18_grayscale(pretrained=False).to(device)
    ...
    test_metrics, test_probs, test_labels = run_one_epoch(
        model,
        test_loader,
        criterion,
        scaler,
    ...
    test_metrics, test_preds = evaluate_binary_predictions(test_labels, test_probs)

    print_metrics(test_metrics, "Test metrics — ResNet18 full image")
